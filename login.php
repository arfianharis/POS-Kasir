...
<head>
    ...
    <link rel="icon" href="kasir.ico">
    <link rel="icon" href="kasir.ico" type="image/ico">
...
<body class="text-center">
    ...
    <form class="form-signin" method="POST">
      <img class="mb-4" src="assets/images/admin.png" alt="" width="72" height="72">
      ...
      <p class="mt-3 mb-3 text-white">&copy; 2023 Developed by - Arfianharis</p>
    </form>
